    ...
    <div class="calendar-home">
            ...
            <div class="title">
                ...
                <el-button-group>
                    ...
                    <el-button
                        ...
                        size="small"
                        :icon="ArrowRightBold"
                        @click="setSwitch('next')"
                    />
                </el-button-group>
                <el-button size="small" @click="setSwitch('today')">
                    今天
                </el-button>
            </div>
            <el-button-group>
                <el-button
                    :type="state.calendarView === 'day' ? 'success' : 'default'"
                    @click="setView('day')"
                >
                    日
                </el-button>
                <el-button
                    :type="
                        state.calendarView === 'week' ? 'success' : 'default'
                    "
                    @click="setView('week')"
                >
                    周
                ...
                <el-button
                    :type="
                        state.calendarView === 'month' ? 'success' : 'default'
                    "
                    @click="setView('month')"
                >
                    月
        ...
        <div class="calendar-wrapper">
            <Calendar
                ...
                :week="state.calendarWeek"
                :month="state.calendarMonth"
                :theme="state.calendarTheme"
                :template="state.calendarTemplate"
                :schedules="list()"
                :taskView="false"
...
const setRenderRange = () => {
    nextTick(() => {
        ...
        if (viewName === "day") {
            ...
            html.push(
                dayjs(
                    state.calendarInstance.getDateRangeStart().getTime(),
                ).format("YYYY.MM.DD"),
            )
            html.push(" ~ ")
            html.push(
                dayjs(
                    state.calendarInstance.getDateRangeEnd().getTime(),
                ).format(" MM.DD"),
            )
        }
